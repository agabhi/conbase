(function(){
  ...
  fabric.util.object.extend(fabric.Canvas.prototype, /** @lends fabric.Canvas.prototype */ {
    ...
    __onMouseDown: function (e) {
      ...
      //Find the target on which mouse is clicked. Can be active group or object.
      var target = this.findTarget(e),
          pointer = this.getPointer(e);      //Pointer coordinates relative to canvas

      // save pointer for check in __onMouseUp event
      this._previousPointer = pointer; //Prev pointer will have mouse down position
